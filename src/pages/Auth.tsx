    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-emerald-100">Join thousands of learners advancing their tech skills</p>
        </div>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20">
              ...
              <CardContent>
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800">
                    Sign In
                  </Button>
                </form>
              </CardContent>
