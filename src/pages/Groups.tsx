    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-100 to-emerald-200 p-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-slate-800">Join collaborative learning communities</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex space-x-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-900">{studyGroups.length}</p>
              <p className="text-slate-700">Active Groups</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-900">{myGroups.length}</p>
          ...
          {myGroups.length === 0 ? (
            <Card className="bg-white/90 backdrop-blur-md border-emerald-200 shadow-lg">
              <CardContent className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold text-slate-800 mb-2">No groups joined yet</h3>
                <p className="text-slate-600 mb-4">Join a study group below to start collaborating!</p>
              </CardContent>
            </Card>
          ) : (
                  ...
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        <CardTitle className="text-slate-900 text-lg">{group.name}</CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {group.topics.map((topic, index) => (
                        <Badge key={index} variant="outline" className="border-emerald-300 text-slate-700 text-xs">
                          {topic}
                        </Badge>
                      ))}
                    </div>
